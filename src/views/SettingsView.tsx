            ...
            <div className="space-y-6">
              ...
              {connectionMode === 'uri' && (
                <div className="space-y-4 bg-slate-950 p-4 rounded-xl border border-slate-800">
                  ...
                  {/* Web Deployment Security Notice */}
                  {!window.electronAPI && (
                    <div className="p-3 bg-emerald-950/40 border border-emerald-800/80 rounded-lg text-emerald-200 text-xs flex items-start gap-2.5">
                      <Shield className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />
                      <div className="space-y-1">
                        <p className="font-bold text-emerald-300">Secure Cloud-Managed Database</p>
                        <p className="text-[11px] text-emerald-200/90 leading-relaxed">
                          Your Supabase PostgreSQL database connection is securely managed via server environment variables on your backend (Render). Credentials and passwords are masked to protect your database when sharing this link.
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      type="text"
                      value={maskUri(dbProvider === 'supabase' ? postgresUriInput : (postgresUriInput || mongoUriInput))}
                      onChange={(e) => {
